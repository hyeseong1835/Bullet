...
public class WeaponEnemyEditorData : EnemyEditorData
{
    public WeaponEnemySpawnData spawnData { get; private set; }
    public override EnemySpawnData SpawnData {
        get => spawnData; 
        protected set => spawnData = (WeaponEnemySpawnData)value;
    }
    public override Type EnemyType => typeof(WeaponEnemy);

    static Event e => UnityEngine.Event.current;

    public WeaponEnemyEditorData(WeaponEnemySpawnData spawnData)
    {
